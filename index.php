                ...
                <div class="col-sm-6 ">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="tel:+84973710159"><i class="fa fa-phone"></i> +84.973.710.159 </a></li>
                            <li><a href="mailto:quyentv209@gmail.com"><i class="fa fa-envelope"></i> quyentv209@gmail.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
...
<footer id="footer"><!--Footer-->
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                <p class="pull-left">Copyright &copy; 2015 Quyentv. All rights reserved.</p>
            </div>
        </div>
    </div>
